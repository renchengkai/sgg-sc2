...
def encode_objects(obj_data, token_to_idx, token_counter):
    encoded_labels = []
    encoded_boxes  = {}
        ...
        for obj in img['objects']:
           # pick a label for the object
            ...
            if obj_label is not None:
                # encode region
                encoded_boxes[1024].append(encode_box(obj))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--object_input', default='./objects.json', type=str)
    parser.add_argument('--relationship_input', default='./relationships.json', type=str)
    parser.add_argument('--metadata_input', default='./image_data.json', type=str)
    parser.add_argument('--object_alias', default='./object_alias.txt', type=str)
    parser.add_argument('--pred_alias', default='./predicate_alias.txt', type=str)
    parser.add_argument('--object_list', default='./object_list.txt', type=str)
    parser.add_argument('--pred_list', default='./predicate_list.txt', type=str)
    ...
    parser.add_argument('--val_frac', default=0.9, type=float)
